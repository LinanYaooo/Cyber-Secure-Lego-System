...
w_ref = 500;                              % Initial Steering Angle;
...
dev_process = 5;                          % Reserved for proecss noise;
Pk_A = [dev_process^2 0; 0 0];            % Motor System Process noise Covariance Matrix;
Pk_B = [dev_process^2 0; 0 0]; 
Pk_C = [dev_process^2 0; 0 0]; 
...
%     end
   ...
   % end
    ...
    [y_mB, x_mB, Pk_B, residual_mB] = NXT_Demo_Kalman_Motor(u_mB, x_mB, y_mea_mB, delta_B_t, Pk_B, mat);
    [y_mA, x_mA, Pk_A, residual_mA] = NXT_Demo_Kalman_Motor(u_mA, x_mA, y_mea_mA, delta_A_t, Pk_A, mat);
    [y_mC, x_mC, Pk_C, residual_mC] = NXT_Demo_Kalman_Motor(u_mC, x_mC, y_mea_mC, delta_C_t, Pk_C, mat);
    ...
    [mB.Power, error_pre_mB, error_sum_mB] = NXT_Demo_PID(0.8, 0.06, 0.3, theta, y_mea_mB, error_Pre_mB, error_sum_mB);
    [mA.Power, error_pre_mA, error_sum_mA] = NXT_Demo_PID(1, 0.01, 0, mA_total, y_mea_mA, error_Pre_mA, error_sum_mA);
    [mC.Power, error_pre_mC, error_sum_mC] = NXT_Demo_PID(1, 0.01, 0, mC_total, y_mea_mC, error_Pre_mC, error_sum_mC);
