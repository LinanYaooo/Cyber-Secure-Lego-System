...
Pk_A = [5^2 0; 0 0];            % Motor System Process noise Covariance Matrix;
Pk_B = [5^2 0; 0 0]; 
Pk_C = [5^2 0; 0 0]; 
...
while true
   ...
   % end
    ...
    [u_mA, error_Pre_mA, error_sum_mA] = NXT_Demo_PID(0.75, 0.001, 0.05, mA_total, y_mea_mA, error_Pre_mA, error_sum_mA);
    [u_mC, error_Pre_mC, error_sum_mC] = NXT_Demo_PID(0.75, 0.001, 0.05, mC_total, y_mea_mC, error_Pre_mC, error_sum_mC);
