...
%     w_ref = -700 * axis(joy, 5); 
    ...
    Y(2) = 0.5 * C_s * x_mB + 0.2 *  pre_y(2) + 0.2 * pre_2y(2) +  0.1 * pre_3y(2);
...
%     
    ...
    [u_mB, error_Pre_mB, error_sum_mB] = NXT_Demo_PID(1.2, 0.05 , 0.4, theta, y_mea(2), error_Pre_mB, error_sum_mB);
