...
%% Threshold Value                   
thre_steering = 5;                      % Define the detection threshold of steering subsystem;
thre_driving = 5;                       % Define the detection threshold of driving subsystem;
...
%     
    ...
    Y(2) =  0.2 * C_s * x_mB +  0.3 * pre_y(2) + 0.3 * pre_2y(2) +  0.2 * pre_3y(2);
